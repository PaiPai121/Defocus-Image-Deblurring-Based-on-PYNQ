...
################################################################
# This is a generated script based on design: Deblur
#
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:WienerDeblur:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: WienerDeblur_0, and set properties
  set WienerDeblur_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:WienerDeblur:1.0 WienerDeblur_0 ]
  ...
  connect_bd_intf_net -intf_net WienerDeblur_0_out_stream [get_bd_intf_pins WienerDeblur_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins WienerDeblur_0/in_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins WienerDeblur_0/s_axi_CONTROL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs WienerDeblur_0/s_axi_CONTROL_BUS/Reg] SEG_WienerDeblur_0_Reg
