...
// ==============================================================
#ifndef __WienerDeblur_mac_JfO__HH__
#define __WienerDeblur_mac_JfO__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mac_JfO) {
    ...
    SC_CTOR(WienerDeblur_mac_JfO):  simcore_mac_1_U ("simcore_mac_1_U") {
