...
// ==============================================================
#ifndef __WienerDeblur_fsubbkb__HH__
#define __WienerDeblur_fsubbkb__HH__
#include "ACMP_fsub.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_fsubbkb) {
    ...
    SC_CTOR(WienerDeblur_fsubbkb):  ACMP_fsub_U ("ACMP_fsub_U") {
        ACMP_fsub_U.clk(clk);
