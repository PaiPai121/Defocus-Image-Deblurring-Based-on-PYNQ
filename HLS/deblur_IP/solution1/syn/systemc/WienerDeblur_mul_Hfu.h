...
// ==============================================================
#ifndef __WienerDeblur_mul_Hfu__HH__
#define __WienerDeblur_mul_Hfu__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mul_Hfu) {
    ...
    SC_CTOR(WienerDeblur_mul_Hfu):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
