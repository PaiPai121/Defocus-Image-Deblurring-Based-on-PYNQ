...
// ==============================================================
#ifndef __WienerDeblur_mul_wdI__HH__
#define __WienerDeblur_mul_wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mul_wdI) {
    ...
    SC_CTOR(WienerDeblur_mul_wdI):  ACMP_mul_su_U ("ACMP_mul_su_U") {
