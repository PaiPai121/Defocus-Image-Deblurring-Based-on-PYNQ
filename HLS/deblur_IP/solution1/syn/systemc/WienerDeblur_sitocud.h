...
// ==============================================================
#ifndef __WienerDeblur_sitocud__HH__
#define __WienerDeblur_sitocud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_sitocud) {
    ...
    SC_CTOR(WienerDeblur_sitocud):  ACMP_sitofp_U ("ACMP_sitofp_U") {
