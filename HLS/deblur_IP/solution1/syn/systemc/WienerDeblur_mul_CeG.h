...
// ==============================================================
#ifndef __WienerDeblur_mul_CeG__HH__
#define __WienerDeblur_mul_CeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mul_CeG) {
    ...
    SC_CTOR(WienerDeblur_mul_CeG):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
