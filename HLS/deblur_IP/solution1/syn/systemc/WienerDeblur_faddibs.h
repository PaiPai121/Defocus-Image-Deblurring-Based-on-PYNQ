...
// ==============================================================
#ifndef __WienerDeblur_faddibs__HH__
#define __WienerDeblur_faddibs__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_faddibs) {
    ...
    SC_CTOR(WienerDeblur_faddibs):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
