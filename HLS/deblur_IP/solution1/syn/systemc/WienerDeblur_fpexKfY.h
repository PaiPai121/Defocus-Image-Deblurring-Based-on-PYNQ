...
// ==============================================================
#ifndef __WienerDeblur_fpexKfY__HH__
#define __WienerDeblur_fpexKfY__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_fpexKfY) {
    ...
    SC_CTOR(WienerDeblur_fpexKfY):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
