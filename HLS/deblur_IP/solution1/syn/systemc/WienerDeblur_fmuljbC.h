...
// ==============================================================
#ifndef __WienerDeblur_fmuljbC__HH__
#define __WienerDeblur_fmuljbC__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_fmuljbC) {
    ...
    SC_CTOR(WienerDeblur_fmuljbC):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
