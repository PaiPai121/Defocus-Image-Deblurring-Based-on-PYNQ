...
// ==============================================================
#ifndef __WienerDeblur_daddLf8__HH__
#define __WienerDeblur_daddLf8__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_daddLf8) {
    ...
    SC_CTOR(WienerDeblur_daddLf8):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
