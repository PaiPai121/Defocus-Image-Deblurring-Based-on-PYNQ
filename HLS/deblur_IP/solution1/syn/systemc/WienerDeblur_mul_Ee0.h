...
// ==============================================================
#ifndef __WienerDeblur_mul_Ee0__HH__
#define __WienerDeblur_mul_Ee0__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mul_Ee0) {
    ...
    SC_CTOR(WienerDeblur_mul_Ee0):  ACMP_mul_us_U ("ACMP_mul_us_U") {
