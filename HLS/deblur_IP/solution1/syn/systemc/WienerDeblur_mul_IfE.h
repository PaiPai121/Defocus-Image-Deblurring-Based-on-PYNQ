...
// ==============================================================
#ifndef __WienerDeblur_mul_IfE__HH__
#define __WienerDeblur_mul_IfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mul_IfE) {
    ...
    SC_CTOR(WienerDeblur_mul_IfE):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
