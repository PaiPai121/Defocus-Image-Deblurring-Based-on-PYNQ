...
// ==============================================================
#ifndef __WienerDeblur_mac_hbi__HH__
#define __WienerDeblur_mac_hbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_mac_hbi) {
    ...
    SC_CTOR(WienerDeblur_mac_hbi):  simcore_mac_0_U ("simcore_mac_0_U") {
