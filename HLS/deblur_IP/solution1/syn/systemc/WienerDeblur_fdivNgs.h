...
// ==============================================================
#ifndef __WienerDeblur_fdivNgs__HH__
#define __WienerDeblur_fdivNgs__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WienerDeblur_fdivNgs) {
    ...
    SC_CTOR(WienerDeblur_fdivNgs):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
