...
module operator_mul_assign_float (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   p_z_M_real_blk_n;
output   p_z_M_imag_blk_n;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_start == 1'b1) & ((p_z_M_imag_empty_n == 1'b0) | (p_z_M_real_empty_n == 1'b0) | (ap_start == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((1'b0 == ap_ce) | ((ap_start == 1'b1) & ((p_z_M_imag_empty_n == 1'b0) | (p_z_M_real_empty_n == 1'b0) | (ap_start == 1'b0))));
end

assign ap_block_state10_pp0_stage0_iter9 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((p_z_M_imag_empty_n == 1'b0) | (p_z_M_real_empty_n == 1'b0) | (ap_start == 1'b0));
end
...
endmodule //operator_mul_assign_float
