...
module operator_mul_float (
        ...
        ap_idle,
        ap_ready,
        gauss_blur_M_real_dout,
        gauss_blur_M_real_empty_n,
        gauss_blur_M_real_read,
        gauss_blur_M_imag_dout,
        gauss_blur_M_imag_empty_n,
        gauss_blur_M_imag_read,
        ap_ce,
        G_M_real_dout,
        G_M_real_empty_n,
        G_M_real_read,
        ...
        ap_return_0,
        ap_return_1,
        gauss_blur_M_real_blk_n,
        gauss_blur_M_imag_blk_n,
        G_M_real_blk_n,
        G_M_imag_blk_n
);
...
output   ap_idle;
output   ap_ready;
input  [31:0] gauss_blur_M_real_dout;
input   gauss_blur_M_real_empty_n;
output   gauss_blur_M_real_read;
input  [31:0] gauss_blur_M_imag_dout;
input   gauss_blur_M_imag_empty_n;
output   gauss_blur_M_imag_read;
input   ap_ce;
input  [31:0] G_M_real_dout;
input   G_M_real_empty_n;
output   G_M_real_read;
input  [31:0] G_M_imag_dout;
input   G_M_imag_empty_n;
output   G_M_imag_read;
output  [31:0] ap_return_0;
output  [31:0] ap_return_1;
output   gauss_blur_M_real_blk_n;
output   gauss_blur_M_imag_blk_n;
output   G_M_real_blk_n;
output   G_M_imag_blk_n;
...
reg    ap_idle_pp0;
wire    grp_operator_mul_assign_float_fu_34_p_z_M_real_blk_n;
wire    grp_operator_mul_assign_float_fu_34_p_z_M_imag_blk_n;
...
reg    grp_operator_mul_assign_float_fu_34_ap_start;
wire    grp_operator_mul_assign_float_fu_34_ap_done;
wire    grp_operator_mul_assign_float_fu_34_ap_idle;
wire    grp_operator_mul_assign_float_fu_34_ap_ready;
wire    grp_operator_mul_assign_float_fu_34_p_z_M_real_read;
wire    grp_operator_mul_assign_float_fu_34_p_z_M_imag_read;
reg    grp_operator_mul_assign_float_fu_34_ap_ce;
wire   [31:0] grp_operator_mul_assign_float_fu_34_ap_return_0;
wire   [31:0] grp_operator_mul_assign_float_fu_34_ap_return_1;
...
always @ (*) begin
    if (((1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp13))) begin
        grp_operator_mul_assign_float_fu_34_ap_ce = 1'b1;
    end else begin
        grp_operator_mul_assign_float_fu_34_ap_ce = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        grp_operator_mul_assign_float_fu_34_ap_start = 1'b1;
    end else begin
        grp_operator_mul_assign_float_fu_34_ap_start = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_start == 1'b1) & ((grp_operator_mul_assign_float_fu_34_p_z_M_imag_blk_n == 1'b0) | (grp_operator_mul_assign_float_fu_34_p_z_M_real_blk_n == 1'b0) | (gauss_blur_M_imag_empty_n == 1'b0) | (gauss_blur_M_real_empty_n == 1'b0) | (ap_start == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp13 = ((ap_start == 1'b1) & ((gauss_blur_M_imag_empty_n == 1'b0) | (gauss_blur_M_real_empty_n == 1'b0) | (ap_start == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((1'b0 == ap_ce) | ((ap_start == 1'b1) & ((grp_operator_mul_assign_float_fu_34_p_z_M_imag_blk_n == 1'b0) | (grp_operator_mul_assign_float_fu_34_p_z_M_real_blk_n == 1'b0) | (gauss_blur_M_imag_empty_n == 1'b0) | (gauss_blur_M_real_empty_n == 1'b0) | (ap_start == 1'b0))));
end
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((grp_operator_mul_assign_float_fu_34_p_z_M_imag_blk_n == 1'b0) | (grp_operator_mul_assign_float_fu_34_p_z_M_real_blk_n == 1'b0) | (gauss_blur_M_imag_empty_n == 1'b0) | (gauss_blur_M_real_empty_n == 1'b0) | (ap_start == 1'b0));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0_ignore_call4 = ((gauss_blur_M_imag_empty_n == 1'b0) | (gauss_blur_M_real_empty_n == 1'b0) | (ap_start == 1'b0));
end
...
assign ap_return_0 = grp_operator_mul_assign_float_fu_34_ap_return_0;

assign ap_return_1 = grp_operator_mul_assign_float_fu_34_ap_return_1;
