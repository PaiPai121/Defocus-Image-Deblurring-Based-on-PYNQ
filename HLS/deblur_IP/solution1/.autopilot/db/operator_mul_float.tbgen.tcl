...
set portList { 
	...
	{ gauss_blur_M_real_blk_n sc_out sc_logic 1 signal -1 } 
	{ gauss_blur_M_imag_blk_n sc_out sc_logic 1 signal -1 } 
	{ G_M_real_blk_n sc_out sc_logic 1 signal -1 } 
	{ G_M_imag_blk_n sc_out sc_logic 1 signal -1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gauss_blur_M_real_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gauss_blur_M_real_blk_n", "role": "default" }} , 
 	{ "name": "gauss_blur_M_imag_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gauss_blur_M_imag_blk_n", "role": "default" }} , 
 	{ "name": "G_M_real_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "G_M_real_blk_n", "role": "default" }} , 
 	{ "name": "G_M_imag_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "G_M_imag_blk_n", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "G_M_real", "Type" : "Fifo", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_operator_mul_assign_float_fu_34", "Port" : "p_z_M_real"}]},
			{"Name" : "G_M_imag", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "G_M_imag_blk_n", "Type" : "RtlPort"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_operator_mul_assign_float_fu_34", "Port" : "p_z_M_imag"}]}],
		"SubInstanceBlock" : [
			{"SubInstance" : "grp_operator_mul_assign_float_fu_34", "SubBlockPort" : ["p_z_M_real_blk_n", "p_z_M_imag_blk_n"]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34.WienerDeblur_fsubbkb_U120", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34.WienerDeblur_faddibs_U121", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34.WienerDeblur_fmuljbC_U122", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34.WienerDeblur_fmuljbC_U123", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34.WienerDeblur_fmuljbC_U124", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_mul_assign_float_fu_34.WienerDeblur_fmuljbC_U125", "Parent" : "1"}]}
