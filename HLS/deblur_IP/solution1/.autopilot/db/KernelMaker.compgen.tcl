...
set out_width 17
set exp i0*i1+i2
set arg_lists {i0 {9 1 +} i1 {9 1 +} m {17 1 +} i2 {17 0 +} p {17 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_kernel_M_real \
    op interface \
    ports { kernel_M_real_din { O 32 vector } kernel_M_real_full_n { I 1 bit } kernel_M_real_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_kernel_M_imag \
    op interface \
    ports { kernel_M_imag_din { O 32 vector } kernel_M_imag_full_n { I 1 bit } kernel_M_imag_write { O 1 bit } } \
} "
}
