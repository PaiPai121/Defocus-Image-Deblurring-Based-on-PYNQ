set moduleName operator_float_397
...
set C_modelName {operator*<float>397}
...
set portList { 
	...
	{ xk1_M_real_blk_n sc_out sc_logic 1 signal -1 } 
	{ xk1_M_imag_blk_n sc_out sc_logic 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "xk1_M_real_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "xk1_M_real_blk_n", "role": "default" }} , 
 	{ "name": "xk1_M_imag_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "xk1_M_imag_blk_n", "role": "default" }} , 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "fft_kernel_M_real", "Type" : "Fifo", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_operator_float_398_fu_34", "Port" : "fft_kernel_M_real"}]},
			{"Name" : "fft_kernel_M_imag", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fft_kernel_M_imag_blk_n", "Type" : "RtlPort"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_operator_float_398_fu_34", "Port" : "fft_kernel_M_imag"}]}],
		"SubInstanceBlock" : [
			{"SubInstance" : "grp_operator_float_398_fu_34", "SubBlockPort" : ["fft_kernel_M_real_blk_n", "fft_kernel_M_imag_blk_n"]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "fft_kernel_M_imag", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fft_kernel_M_imag_blk_n", "Type" : "RtlPort"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34.WienerDeblur_fsubbkb_U42", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34.WienerDeblur_faddibs_U43", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34.WienerDeblur_fmuljbC_U44", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34.WienerDeblur_fmuljbC_U45", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34.WienerDeblur_fmuljbC_U46", "Parent" : "1"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_operator_float_398_fu_34.WienerDeblur_fmuljbC_U47", "Parent" : "1"}]}
